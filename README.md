...
Fasta files and sample information can be found at NCBI BioProject: PRJNA1387154
The naming convention for fasta files are: site-FL-type-number, where sites are Askö (A), Kalvöfjorden (K), Nordön (N) and Ryskärsfjorden (R), while types are attached to hard substrate (A) and drifting on soft bottom sediments (M and T). For example, an attached sample from Askö is called A-FL-A-5.
